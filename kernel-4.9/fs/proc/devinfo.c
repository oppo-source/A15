...
struct devinfo g_devinfo_items[] = {
	...
	#ifdef ODM_WT_EDIT
	// Huangmiao@ODM_WT.BSP.Sensors.Config, 2020/08/26, Add proc/devinfo/camera_main camera_aux for engineermode
	{"camera_main", "Null", "Null","Null",0},
	{"camera_aux", "Null", "Null","Null",0},
	#endif
