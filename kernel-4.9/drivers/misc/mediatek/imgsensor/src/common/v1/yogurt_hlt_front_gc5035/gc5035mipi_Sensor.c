...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = YOGURT_HLT_FRONT_GC5035_SENSOR_ID,
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == YOGURT_HLT_FRONT_GC5035_SENSOR_ID) {
...
UINT32 GC5035_HLT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	cam_pr_debug("E\n");
