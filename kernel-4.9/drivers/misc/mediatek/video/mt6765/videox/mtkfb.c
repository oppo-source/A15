...
#if 0
/*hongwu.wei @PSW.MM.Display.LCD.Machine, 2020/07/03,add checklist feature*/
#ifdef VENDOR_EDIT
#if defined(OPPO17321_TIANMA_TD4310_1080P_DSI_VDO)
/* Rongchun.Zhang@PSW.MM.Display.LCD.Machine, 2017/09/14, Add for outdoor mode */
...
int mtkfb_set_backlight_level(unsigned int level)
{
	...
	if (level > 1 && strcmp(_get_context()->plcm->drv->name,"oppo17321_boe_td4310_1080p_dsi_vdo")
		&& strcmp(_get_context()->plcm->drv->name,"oppo17031_samsung_ams601nv_1080p_dsi_cmd")) {
		if (outdoor_mode == 0) {
			level = (level * 967) / 1000;
		}
	}
	//#endif
#endif
...
static int mtkfb_probe(struct platform_device *pdev)
{
	...
	if( (!strcmp(mtkfb_find_lcm_driver(),"nt36525b_hlt_psc_hdp_dsi_vdo_lcm")) || (!strcmp(mtkfb_find_lcm_driver(),
		...
		"nt36525b_txd_yogurt_hdp_dsi_vdo_lcm")) || (!strcmp(mtkfb_find_lcm_driver(),
		"nt36525b_hlt_yogurt_hdp_dsi_vdo_lcm")) || (!strcmp(mtkfb_find_lcm_driver(),
		"ilt9882n_huaxian_yogurt_hdp_dsi_vdo_lcm")) || (!strcmp(mtkfb_find_lcm_driver(),
		"ilt9881h_inx_yogurt_hdp_dsi_vdo_lcm")) ) {
